...
\begin{itemize}
  ...
  \item \textbf{Write your proofs in prose.} A proof is a short essay, not a column of symbols. If you can't explain each step in a sentence, you probably don't understand the step. The ``How to Write a Proof'' chapter (placed immediately after Module~1) is worth re-reading after every few proofs you write.
