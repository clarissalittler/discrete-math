...
\begin{mdframed}[linewidth=0.6pt, linecolor=gray!60, backgroundcolor=gray!4, innertopmargin=6pt, innerbottommargin=6pt]
...
It's worth noting that in a lot of logics negation is \emph{defined} as $\lnot p \;:=\; p \to \bot$. One such logic is the logic behind Lean 4, which you'll be playing with as part of learning The Natural Number Game.
