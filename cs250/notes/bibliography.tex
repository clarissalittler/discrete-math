...
\begin{itemize}
  \item \textbf{[start here]} Conor McBride, ``The Derivative of a Regular Type is its Type of One-Hole Contexts,'' unpublished manuscript (2001), available on the author's homepage at \texttt{strictlypositive.org}. A short, witty, surprisingly elementary derivation of why \emph{differentiating} an algebraic data type literally gives you its zipper. Connects high-school calculus to programming in a way undergraduates love.
