...
(1) (p -> q) ^ (p -> r)     by assumption
(2) p -> q                  by ^-elimination on (1)
(3) p -> r                  by ^-elimination on (1)
(4) subproof:
      (4a) p                by assumption
      (4b) q                by modus ponens on (4a), (2)
      (4c) r                by modus ponens on (4a), (3)
      (4d) q ^ r            by ^-introduction on (4b), (4c)
    shows q ^ r
(5) p -> (q ^ r)            by ->-introduction on subproof (4)
\end{lstlisting}
...
(2) subproof:
      (2a) p                by assumption
      (2b) q ^ r            by modus ponens on (2a), (1)
      (2c) q                by ^-elimination on (2b)
    shows q
(3) p -> q                  by ->-introduction on subproof (2)
(4) subproof:
      (4a) p                by assumption
      (4b) q ^ r            by modus ponens on (4a), (1)
      (4c) r                by ^-elimination on (4b)
    shows r
(5) p -> r                  by ->-introduction on subproof (4)
(6) (p -> q) ^ (p -> r)     by ^-introduction on (3), (5)
\end{lstlisting}
