...
\textbf{Logical equivalence.} Two formulas are logically equivalent (written $\equiv$) if they have the same truth table---or equivalently, if the biconditional between them is a tautology. See Module~2.
