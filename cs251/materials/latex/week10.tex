...
\begin{example}[Master theorem, Case 3]
Solve $T(n) = 2T(n/2) + n^2$.

\emph{Solution.} Here $a = 2$, $b = 2$, so $c = \log_2 2 = 1$. We have $f(n) = n^2 = \Omega(n^{c+1})$.

Regularity check:
\[
a f(n/b) = 2 \left(\frac{n}{2}\right)^2 = \frac{n^2}{2} \leq \frac{1}{2} f(n).
\]
