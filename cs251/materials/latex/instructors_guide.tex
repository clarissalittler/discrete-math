...
\subsection{Proof Grading Rubric (Suggested)}
\begin{center}
\begin{tabularx}{\linewidth}{l X c}
\toprule
\textbf{Criterion} & \textbf{Description} & \textbf{Pts} \\
\midrule
Structure & States the claim, identifies a strategy, and closes the argument clearly. & 2 \\
Logic & Each step follows from prior steps or cited facts; no gaps or contradictions. & 4 \\
Clarity & Uses complete sentences; explains nontrivial steps. & 2 \\
Notation & Uses symbols and definitions correctly. & 1 \\
Completeness & Addresses all cases/quantifiers required by the statement. & 1 \\
\bottomrule
\end{tabularx}
\end{center}

Adjust weights as needed for your course goals (e.g., emphasize clarity for early weeks).

\subsection{Session Timing Variants}
\begin{center}
\begin{tabular}{lcccc}
\toprule
\textbf{Variant} & \textbf{Warm-up} & \textbf{Lecture 1} & \textbf{Activity} & \textbf{Lecture 2 / Wrap-up} \\
\midrule
75 min  & 5  & 25 & 15 & 30 \\
90 min  & 10 & 30 & 15 & 35 \\
110 min & 10 & 35 & 20 & 45 \\
...
\end{tabular}
\end{center}
These are templates; swap time between lecture and activity depending on class needs.
